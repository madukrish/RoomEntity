 ...
 */
class CRM_Myextension_Form_MyRoomForm extends CRM_Core_Form {
   ...
   */
  function addRules() {
    $this->addFormRule(array('CRM_Myextension_Form_MyRoomForm', 'myRules'));
  }
  /**
   * Validation callback
   */
  static function myRules($values) {
    ...
    if ($values['room_label'] = '') {
      $errors['room_label'] = ts('You entered the wrong text!');
    }
